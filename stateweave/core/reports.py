    ...
    def to_markdown(self) -> str:
        ...
        lines.extend(
            [
                "",
                "---",
                f"*Generated by [StateWeave](https://stateweave.dev) v{self.source.stateweave_version}*",
            ]
        )
...
<body>
  ...
  <div class="footer">
    Generated by <a href="https://stateweave.dev">StateWeave</a> v{self.source.stateweave_version}
  </div>
</body>
</html>"""
